...
int main(int argc, char** argv) {
    ...
    out<<"Percentage Wins  = "<<nRolls<<endl;
    out<<"Percentage Losses  = "<<nRolls<<endl;
    out<<"Number of total rolls  = "<<nRolls<<endl;
    out<<"Max number of rolls in a game = "<<1.0*mxRolls<<endl;
    out<<"The Average number of rolls"<<nRolls/nGames<<endl;
