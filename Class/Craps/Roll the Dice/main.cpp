...
int main(int argc, char** argv) {
    ...
    char die1, die2, sum;
    int nRolls, check;
    int n2s=0, n3s=0, n4s=0, n5s=0, n6s=0, n7s=0, n8s=0, n9s=0, 
            n10s=0, n11s=0, n12s=0;
    ...
    for(int roll=1;roll<=nRolls;roll++){
        ...
        switch(sum){
            ...
            case 12:n12s++;break;
            default:{
                cout<<"Not possible sum"<<endl;
                exit(EXIT_FAILURE);
            }
        }
    }
    
    check=n2s+n3s+n4s+n5s+n6s+n7s+n8s+n9s+n10s+n11s+n12s;
